...
$(document).ready(function(){
		...
		$(".slider_us .slider ul li").eq(0).addClass("current");/*addClass():添加class*/
		$(".slider_us .slider ul li").click(function(){
		...
		function show(){  /*function 函数名(){}:封装函数*/
			...
			$(".slider_us .slider ul li").eq(num).addClass("current").siblings().removeClass("current");	
			...
			$(".slider_us").mouseover(function(){  /*mouseover():鼠标经过事件*/
				clearInterval(lun)  /*clearInterval():清除定时器*/
				})
			
			$(".slider_us").mouseout(function(){   /*mouseout():鼠标离开事件*/
